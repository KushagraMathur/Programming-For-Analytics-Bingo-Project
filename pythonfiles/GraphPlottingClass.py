...
class GraphPlottingClass:
    ...
    def plotLineGraph(self, numOfWinnersDict, inputToValueDict):
        ...
        '''
        Below "for" loop extracts the number of winners after each number called for each simulations. Using the number of winners
        ...
        for key, value in numOfWinnersDict.items():
         ...
         # creating a dictionary which contains values for median, Standard Deviation, skew, kurtosis and percentiles.
        ...
        # Convert the dictionary into panda dataframe in order to export the centrality data.
        ...
        # Convert both the graphs obtained into a jpeg image.
